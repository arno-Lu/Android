...
import com.ckt.io.wifidirect.Views.SendFileListPopWin;
...
public class ContentFragment extends Fragment implements View.OnClickListener, MainActivity.OnSendFileListChangeListener {
    ...
    private int viewPagerTitleIds[] = {R.id.id_connect_title,R.id.id_application_title, R.id.id_music_title, R.id.id_movie_title, R.id.id_file_title, R.id.id_history_title};
